...
public class MainActivity extends AppCompatActivity implements
    ...
    public void showCharging(boolean charging) {
        Drawable image;
        if (charging) {
            image = getResources().getDrawable(R.drawable.ic_power_pink_80px);
        } else {
            image = getResources().getDrawable(R.drawable.ic_power_grey_80px);
        }
    ...
    public class ChargingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            showCharging(action != null && action.equals(Intent.ACTION_POWER_CONNECTED));
        }
    }
}