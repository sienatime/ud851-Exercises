...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 5151;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 1577;
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        return new NotificationCompat.Action(
                ...
                context.getString(R.string.drank_water),
                pendingIntent
        );
    }
